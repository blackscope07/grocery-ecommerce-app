...
INSERT INTO `customer_order` VALUES (1,'2022-05-01',4);
...
INSERT INTO `delivery` VALUES (1,'Anna Nagar east','2022-05-11','Delivered',4);
...
INSERT INTO `ordered_products` VALUES (1,'Cadbury Dairy Milk Silk Roast Almond Bars  (143 g)',566,1,1);
...
--
-- Table structure for table `sellergrocerydb`
--

DROP TABLE IF EXISTS `sellergrocerydb`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `sellergrocerydb` (
  `seller_id` int DEFAULT NULL,
  `seller_contact` bigint DEFAULT NULL,
  `seller_name` text
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `sellergrocerydb`
--

LOCK TABLES `sellergrocerydb` WRITE;
/*!40000 ALTER TABLE `sellergrocerydb` DISABLE KEYS */;
INSERT INTO `sellergrocerydb` VALUES (1,9909908888,'AAA Foods'),(2,8899776655,'ABC foods'),(3,9090889090,'FarmFresh');
/*!40000 ALTER TABLE `sellergrocerydb` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `transaction` VALUES (1,566,'2022-05-01','Offline - Cash On Delivery',4,1);
...
-- Dump completed on 2022-05-02 10:07:51
